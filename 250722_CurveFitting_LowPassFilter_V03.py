    ...
    if "beads" in st.session_state:
        ...
        for start, end in beads:
            ...
            if filter_type == "Butterworth":
                ...
                nir_filter = savgol_filter(nir, window_length=ma_window if ma_window % 2 else ma_window+1, polyorder=order)
                vis_filter = savgol_filter(vis, window_length=ma_window if ma_window % 2 else ma_window+1, polyorder=order)
