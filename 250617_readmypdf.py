# -*- coding: utf-8 -*-
"""250617_ReadMyPDF.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1WqUaM7V8sCaCrWDAW5laeLf0h5NsVOGd
"""
...
# Set up OpenAI API securely (via .streamlit/secrets.toml)
...
def extract_pdfs(zip_file):
    ...
    return pdf_info, non_pdf_files, temp_dir
...
if uploaded_zip:
    ...
    for file_name in selected_files:
        with st.expander(f"📄 {file_name}"):
            ...
            if st.button(f"Explain this file name", key=file_name):
                with st.spinner("🔍 Analyzing with GPT..."):
                    try:
                        ...
                        st.error("❌ GPT response parsing failed.")
